...
This package is described in [Geha et al. (2026, Paper I)](https://arxiv.org/abs/2602.10202) and determines line-of-sight velocity and equivalent measurement for individual stars as observed by the Keck/DEIMOS spectrograph. The pipeline operates on 1D spectra which have been reduced by [PypeIt](https://github.com/pypeit/PypeIt).   
 - For `dmost` reduced data products for individual Milky Way stars, see Paper I and [data access pages](https://geha-group.github.io/deimos/).
