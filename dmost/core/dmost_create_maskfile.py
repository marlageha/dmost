...
def create_slits(nslits,nexp):
    ...
    cols = [filled_column('objname','                ',nslits),
            ...
            # EMCEE
            filled_column('emcee_v',-999.*np.ones(nexp),nslits),
            filled_column('emcee_w',-999.*np.ones(nexp),nslits),
            filled_column('emcee_v_err',-999.*np.ones(nexp),nslits),
            filled_column('emcee_w_err',-999.*np.ones(nexp),nslits),
            filled_column('emcee_v_err16',-999.*np.ones(nexp),nslits),
            filled_column('emcee_v_err84',-999.*np.ones(nexp),nslits),
            filled_column('emcee_w_err16',-999.*np.ones(nexp),nslits),
            ...
            filled_column('emcee_kertosis',-999*np.ones(nexp),nslits),
            filled_column('emcee_good',-1*np.ones(nexp),nslits),

   
            # LOW SN V
            filled_column('coadd_v',-999.,nslits),
            filled_column('coadd_w',-999.,nslits),
            filled_column('coadd_v_err',-999.,nslits),
            filled_column('coadd_w_err',-999.,nslits),
            filled_column('coadd_v_err16',-999.,nslits),
            filled_column('coadd_v_err84',-999.,nslits),
            filled_column('coadd_f_acc',-999.,nslits),
            filled_column('coadd_converge',-999.,nslits),
            filled_column('coadd_burnin',-999,nslits),
            filled_column('coadd_nsamp',-999.,nslits),
            filled_column('coadd_lnprob',-999.,nslits),
            filled_column('coadd_skew',-999.,nslits),
            filled_column('coadd_kertosis',-999.,nslits),
            filled_column('coadd_good',-999,nslits),
            filled_column('coadd_flag',-999,nslits),

            # COMBINED VELOCITIES
            filled_column('dmost_v',-999.,nslits),
            filled_column('dmost_v_err',-999.,nslits),
            filled_column('dmost_v_err_rand',-999.,nslits),
            filled_column('v_nexp',-999,nslits),

            # SHORT BINARY FLAGS
            filled_column('var_short_pval',-999.,nslits),
            filled_column('var_short_max_v',-999.,nslits),
            filled_column('var_short_max_t',-999.,nslits),
            filled_column('flag_short_var',-999,nslits),


           # EQUIVALENT WIDTHS FROM COADD1D FILES
            filled_column('cat',-999.,nslits),
            filled_column('cat_err',-999.,nslits),
            filled_column('cat_all',-999.*np.ones(3),nslits),
            filled_column('cat_all_err',-999.*np.ones(3),nslits),
            filled_column('cat_chi2',-999.,nslits),
            filled_column('cat_gl',-999.,nslits),
            filled_column('naI',-999.,nslits),
            filled_column('naI_err',-999.,nslits),
            filled_column('mgI',-999.,nslits),
            filled_column('mgI_err',-999.,nslits),
            filled_column('mgI_err_rand',-999.,nslits),
            filled_column('naI_err_rand',-999.,nslits),
            filled_column('cat_err_rand',-999.,nslits)
...
def add_chipgap_seeing(data_dir,mask,slits,log):
    ...
    for ii,msk in enumerate(mask):
        ...
        try:
            ...
            mask['slitwidth'][ii] = 0.7 # Rare exception where raw files missing this extension 
